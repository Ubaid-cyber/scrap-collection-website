export default function Pricing() {
  ...
  return (
    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 p-6">
      ...
      <section className="relative w-full max-w-4xl overflow-hidden rounded-2xl border border-black/5 bg-white p-10 shadow-xl">
        {/* Glow */}
        ...
        <div className="relative">
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <div
                key={c.t}
                className="rounded-xl border border-slate-200 p-6 hover:shadow-lg transition bg-white/50 backdrop-blur-sm"
              >
